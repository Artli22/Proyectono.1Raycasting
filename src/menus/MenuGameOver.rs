...
pub fn mostrar(rl: &mut RaylibHandle, thread: &RaylibThread) -> bool {
    ...
    while !rl.window_should_close() {
        ...
        let img_w = (boni_texture.width() as f32 * img_h as f32 / boni_texture.height().max(1) as f32) as i32;
        let img_x = (screen_width - img_w) / 2;
        d.draw_texture_pro(
            &boni_texture,
            Rectangle::new(0.0, 0.0, boni_texture.width() as f32, boni_texture.height() as f32),
