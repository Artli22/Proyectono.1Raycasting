...
pub const DURACION_JUEGO_SEGUNDOS: f32 = 360.0; // 6 minutos
pub const TIEMPO_INICIO_ENEMIGOS: f32 = 300.0;   // enemigos activos tras el primer minuto
pub const VELOCIDAD_ENEMIGO: f32 = 20.0;         // unidades del mundo por segundo
